          ...
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-16 items-center justify-between">
              <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                {/* Mobile menu button*/}
                <Disclosure.Button className="inline-flex items-center justify-center rounded-md p-2 text-ctp-subtext0 hover:bg-ctp-base hover:text-ctp-subtext0 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
                  ...
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      classNames(
                        isActive
                          ? 'bg-ctp-mantle text-ctp-text'
                          : 'text-ctp-subtext0 hover:bg-ctp-mantle hover:text-ctp-text',
